...
# The population table does not contain information for Puerto Rico. This could be a problem when the pills table recognizes Puerto Rico as part of the shipments, but the population does not. If you are looking at which counties received the most pills, Puerto Rico will not be considered.
...
geo_pills_population_state_2009 %>%
  ...
  geom_sf(lwd = 0) +
  theme_map() +
  labs(fill='Pills Per Person',title="North, South Dakota and Illinois Have Highest Pill Density Per Population", subtitle = "2009 population, U.S. Census", caption = "Source: U.S. Census ACS") +
...
geo_pills_population_state %>%
  ...
  geom_sf(lwd = 0) +
  theme_map() +
  labs(fill='Pills per Person',title="Pill Totals Per Person Decrease From 2006 to 2012", subtitle = "Source: U.S. Census ACS", caption = "Source: ARCOS database") +
  theme(legend.position="bottom") +
  scale_fill_viridis_c(option = "magma",labels = comma)
...
mapview(geo_pills_population_county_2009, zcol = "estimate", legend = TRUE)
