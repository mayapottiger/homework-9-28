...
# Total pills peaked in 2008. The number of pills sent steadily increased from 2006 to 2008, but then dedlined following that with a dramatic decrease from 2009 to 2010, and then a slight decrease each year after that.
